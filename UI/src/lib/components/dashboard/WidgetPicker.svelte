<script lang="ts">
	...
	import { Modal, Card, Badge, Input } from 'flowbite-svelte';
...
<Modal bind:open={isOpen} size="lg" class="w-full">
	<div class="p-6">
		<!-- Header -->
		<div class="mb-6 flex items-center justify-between">
			<h3 class="text-xl font-semibold text-gray-900">Add Widget</h3>
			<CompatButton on:click={handleClose} color="light" size="sm">✕</CompatButton>
		</div>
				...
				>
					<div class="flex h-full flex-col">
						...
						<div class="flex items-center justify-between text-xs text-gray-500">
							...
							<CompatButton size="xs" color="blue">
